...
function $r(t, e, [n]) {
  ...
  const r = mn(t).filter(([s, i]) => i !== n);
  e.deleteAttr(n), Tn(t, e, r);
}
function Dr(t, e, [n]) {
  e.getAttr(n.id) && (e.updateAttr(n), Tn(t, e, mn(t)));
}
function Rr(t, e, n) {
  const [r, ...s] = n;
  switch (r) {
...
function Ps(t, e, { etype: n, pageInfo: r, dq: s, form: i }) {
  var y, g;
  const o = (y = i == null ? void 0 : i.$) == null ? void 0 : y.order, a = kn(i), c = js(i);
  let u = Jr(t, s);
  ...
  u.sort(
    c === "asc" ? function(_, b) {
      return Ie(_, b, d == null ? void 0 : d["checked-data-type"]);
    } : function(_, b) {
      return Ie(b, _, d == null ? void 0 : d["checked-data-type"]);
    }
  );
  let f = {};
  const p = Cs(e, n, s);
...
function $s(t, e, { etype: n, level: r, form: s, join: i, pageInfo: o }) {
  ...
  const a = bs(
    ...
    i
  ), c = Ss(Pe, n, r), u = (p = s.$) == null ? void 0 : p.fields, l = Ps(t, e, {
    etype: n,
    pageInfo: o,
    form: s,
...
function _t({
  ...
  const o = { data: Object.keys(s).reduce(function(c, u) {
    return r != null && r[u] || u === "$$ruleParams" || (c[u] = En(t, e, {
      etype: u,
      form: s[u],
      level: 0,
...
function Ys({ attrsStore: t }, [e, n, r]) {
...
function _e(t, e, n, r) {
  const s = t ? ti(t, e, n) : null, i = P(), a = [P(), e, n];
  return {
    id: i,
    "forward-identity": a,
    "value-type": "blob",
...
function li({ attrsStore: t, schema: e }, n) {
  var f, p;
...
class rt {
  ...
  updateInPlace(e) {
    this._version++;
    const [n, r] = Ee(this.currentValue, e, {
      enablePatches: !0
    });
    for (const s of r) {
      const i = s.path[0];
...
class jn extends fi {
  constructor(n, r) {
    ...
    h(this, "_prefix");
    h(this, "_dbPromise");
    this.dbName = `instant_${n}_${hi}`, this._storeName = r, this._appId = n, this._dbPromise = this._init();
  }
  _init() {
    return new Promise((n, r) => {
      let s = !1;
...
class je extends pe {
  constructor(n) {
    ...
    h(this, "status");
    const s = new.target.prototype;
    Object.setPrototypeOf && Object.setPrototypeOf(this, s), Error.captureStackTrace && Error.captureStackTrace(this, je), this.name = "InstantAPIError", this.status = n.status, this.body = n.body;
  }
  get [Symbol.toStringTag]() {
...
const Wt = [
  ...
  "fields",
  "aggregate"
], $i = (t) => t.valueType || "unknown", Ln = (t, e, n = !1) => {
...
const Kn = (t) => t.length > 0 ? t.join(", ") : "none", Ui = (t, e) => new K(
...
class Ji {
  ...
  onSyncLoadBatch(e) {
    ...
    const c = a.entities;
    for (const u of r) {
      const l = this.createStore(u), d = Fe(o, l, a.attrsStore);
      c.push({
        store: l,
        entity: d,
        serverCreatedAt: Yt(
  ...
  onSyncUpdateTriples(e) {
    ...
    for (const a of e.txes) {
      ...
      const g = Gi(s, this.getAttrs);
      Bi(s, g, d), this.notifyCbs(r, {
...
}, Ke = "_instant_oauth_redirect", oe = "currentUser";
function no({
  transportType: t,
  appId: e,
  apiURI: n,
...
class uo {
  ...
  _initStorage(e) {
    this.querySubs = new rt({
      ...
      merge: co,
      serialize: io,
      parse: (n, r) => so(r, this.config.useDateObjects),
      // objectSize
      objectSize: (n) => {
        var r, s, i;
...
function To(t, e) {
  Te == null || Te.dispose();
  const n = ko(e), r = Ao(e, a), s = So(mo(t));
  function i(l) {
    var d;
...
function Eo(t, e) {
  return e && e.refresh_token ? new Response(JSON.stringify({ ok: !0 }), {
    headers: {
      "Content-Type": "application/json",
      // 7 day expiry
      "Set-Cookie": `instant_user_${t.appId}=${JSON.stringify(e)}; Path=/; HttpOnly; Secure; SameSite=Strict; Max-Age=604800`
    }
  ...
  constructor(e) {
    ...
    h(this, "addQueryResult", (e, n) => {
      this.resultMap.set(e, {
        ...
        promise: null,
        error: null
      }), Io || (this.db._reactor.attrs || this.db._reactor._setAttrs(n.attrs), this.db._reactor._addQueryData(
        n.query,
        n,
...
class Ro {
  constructor(e) {
    ...
    h(this, "storage");
    h(this, "tx", Mn());
    this._reactor = e, this.auth = new jo(this._reactor), this.storage = new $o(this._reactor);
  }
  /**
...
function Lo(t, e) {
  ...
  n.allowedHosts.includes(window.location.hostname) && To(t, n);
}
const Qo = Uo;
export {
  jo as Auth,
